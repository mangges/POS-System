...
>
    ...
    <x-filament::dropdown.list>
        <x-filament::dropdown placement="left-start" :shift="true">
            <x-slot name="trigger">
                <button type="button" class="fi-dropdown-list-item">
                    {{ \Filament\Support\generate_icon_html(\Filament\Support\Icons\Heroicon::OutlinedLanguage) }}
            ...
            <x-filament::dropdown.list>
                @foreach ($locales as $locale => $label)
                    <x-filament::dropdown.list.item
                        ...
                        :icon="app()->getLocale() === $locale ? \Filament\Support\Icons\Heroicon::CheckCircle : null"
